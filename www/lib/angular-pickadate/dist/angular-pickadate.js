          ...
          '<div class="pickadate">' +
            '<div class="pickadate-header">' +
              '<div class="pickadate-controls">' +
                '<a href="" class="pickadate-prev" ng-click="changeMonth(-1)" ng-show="allowPrevMonth"><-Mes Ant </a>' +
                '<a href="" class="pickadate-next" ng-click="changeMonth(1)" ng-show="allowNextMonth"> Mes Sig-></a>' +
              '</div>'+
        ...
        link: function(scope, element, attrs, ngModel)  {
          ...
          scope.render = function(initialDate) {
            ...
            var currentMonth    = initialDate.getMonth() + 1,
              ...
              nextMonthDates    = dateUtils.dateRange(1, 2, lastDate),
